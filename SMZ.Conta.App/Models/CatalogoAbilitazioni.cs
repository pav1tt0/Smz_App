...
public static class CatalogoAbilitazioni
{
    ...
    [
        new TipoAbilitazione { TipoAbilitazioneId = 1, Codice = "ARA", Descrizione = "Sommozzatore abilitato ARA", Categoria = "Subacquea", RichiedeLivello = false, RichiedeScadenza = false, RichiedeProfondita = true },
        ...
        new TipoAbilitazione { TipoAbilitazioneId = 3, Codice = "ARM", Descrizione = "Sommozzatore abilitato ARM", Categoria = "Subacquea", RichiedeLivello = false, RichiedeScadenza = false, RichiedeProfondita = true },
        new TipoAbilitazione { TipoAbilitazioneId = 4, Codice = "ASAS", Descrizione = "Sommozzatore abilitato ASAS", Categoria = "Subacquea", RichiedeLivello = false, RichiedeScadenza = false, RichiedeProfondita = true },
        ...
        new TipoAbilitazione { TipoAbilitazioneId = 14, Codice = "PATENTE_GUIDA", Descrizione = "Patente di guida", Categoria = "Guida", RichiedeLivello = true, RichiedeScadenza = true, RichiedeProfondita = false },
